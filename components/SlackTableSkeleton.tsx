                ...
                <div className="squeak-post">
                    ...
                    <div className="squeak-post-content pb-2 mt-2">
                        ...
                        <div className="squeak-post-markdown mb-2 animate-pulse">
                            <div className="!w-full h-12 overflow-hidden text-ellipsis !bg-gray-light !bg-opacity-20 cursor-not-allowed px-3 py-4 max-w-full rounded-bl rounded-br !border-t-1 border-solid border-color-[#fff]">
                            </div>
                        </div>
