        ...
        <>
            {slackSetup ? (
                ...
                <div className="flex flex-col">
                    <p className="pt-0 pb-4">Select from the most recent 50 threads in a specified Slack channel to import and display on your site. Just set a title and the relative URL(s) where the question should appear.</p>
                        <div className="relative max-w-[600px]">
                                <div className="flex items-center pb-4">
                                    ...
                                    <label for="toggle-all" className="text-sm cursor-pointer mr-4">Toggle all</label>
                                                        ...
                                                        <div className="squeak-post">
                                                            ...
                                                            <div className="squeak-post-content pb-2">
                                                                ...
                                                                <input
                                                                    ...
                                                                    placeholder="URL"
                                                                />
                                                                <p className="text-sm text-gray-500">Ex: /relative/path-to/page</p>
                                                            </div>
                                                        </div>
...
Slack.getLayout = function getLayout(page: ReactElement) {
    return (
        <AdminLayout contentStyle={{ maxWidth: 1200, margin: '0 auto', paddingLeft: '1rem' }} title={'Import Slack threads'}>
            {page}
        </AdminLayout>
    )
}
